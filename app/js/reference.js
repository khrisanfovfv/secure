...
var reference = {
    ...
    get_card_name(prefix) {
        ...
        switch (prefix) {
            ...
            case '#contract_card__documents' : card = 'document_card'; break;
            ...
            case '#settings_card': card = 'settings_card'; break;
    ...
    binding_event_card(prefix, detail = ''){
        ...
        if (detail == ''){
            ...
            switch(detail){
                ...
                case '#settings_card' : settings_card_binding_events(); break;
            }
        }
    },
