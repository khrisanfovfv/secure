    ...
    <div class="content">
        <div class="reference">
            ...
            <div class="reference__buttons">
                ...
                <button class="reference__button reference__button_select" id="organization_ref__select" disabled>
                ...
                <button class="reference__button" id="organization_ref__delete" disabled>
                    <img src="<?php echo  $button_icons->delete ?>" alt="Удалить">
                    <p>Удалить</p>
                </button>
                <button class="reference__button" id="organization_ref__excel">
            ...
            <div class="organization_ref__container">
                <table class="reference__table" id="organization_ref__table">
                    <thead>
                        ...
                        <tr>
                            <th></th>
                            <th><input class="organization_filter" id="organisation_ref__fbriefname"></th>
                            <th><input class="organization_filter" id="organisation_ref__ffullname"></th>
                            <th><input class="organization_filter" id="organisation_ref__fboss"></th>
                            <th><input class="organization_filter" id="organisation_ref__femail"></th>
                            <th><select class="organization_filter" id="organisation_ref__fstate">
                                <option value=""></option>
